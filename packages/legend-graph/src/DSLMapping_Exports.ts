...
export { DEPRECATED__MappingTest as MappingTest } from './graph/metamodel/pure/packageableElements/mapping/DEPRECATED__MappingTest.js';
...
export * from './graphManager/protocol/pure/DSLMapping_PureProtocolProcessorPlugin_Extension.js';
...
export { V1_getIncludedMappingPath } from './graphManager/protocol/pure/v1/helpers/V1_DSLMapping_Helper.js';
